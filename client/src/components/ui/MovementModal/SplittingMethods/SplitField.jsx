...
export default function SplitField({
  ...
  const maxValue = isFixed ? 99999999 : 100; // Set max value for fixed entries
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        >
          <span className={`text-sm ${!isEnabled ? "opacity-50 select-none pointer-events-none" : ""}`}>{integerPart}</span>
          {decimalPart !== undefined && (
            <div className={`${!isEnabled ? "opacity-50 select-none pointer-events-none" : ""}`}>
        ...
        <Input
          ...
          inputMode={isFixed ? "numeric" : "decimal"} // Show decimal keyboard on mobile
          value={displayValue}
